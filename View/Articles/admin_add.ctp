<p class="left"><?PHP echo $this->Html->link('登録せずに一覧に戻る', array('action' => 'index'), array('class' => 'btn')); ?>
</p><?PHP
...
<table class="form">
	<tr>
		<th colspan="2" class="title">新規追加</th>
	</tr>
	<tr>
...
<?PHP echo $this->Form->submit('新規追加する', array('name' => 'submit', 'class' => 'btn btn-large')); ?>
